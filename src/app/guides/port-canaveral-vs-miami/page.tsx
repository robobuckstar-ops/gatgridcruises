    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="my-6 text-center">
        ...
        <section className="bg-gradient-to-b from-[#0a1628] to-[#1E3A5F] p-8 rounded-lg mb-12 text-white">
          ...
          <Link href="/tools/cost-calculator" className="inline-flex items-center gap-2 bg-[#D4AF37] text-[#1E3A5F] font-bold py-3 px-6 rounded-lg hover:bg-yellow-300 transition">
