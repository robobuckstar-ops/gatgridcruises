        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
            {[
              ...
              { icon: Gift, title: 'Free Onboard Credit', desc: 'GatGrid clients receive free OBC added to their stateroom account through Boardwalk Travel. Spend it on spa, dining, or excursions.' },
      ...
      <section className="bg-[#162d4a] border-y-2 border-[#D4AF37]/60 py-14 md:py-18" aria-labelledby="obc-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <h2 id="obc-heading" className="font-fraunces text-3xl md:text-4xl font-bold text-white mb-3">
                Get Free Onboard Credit on Every Booking*
              </h2>
          ...
          <p className="mt-6 text-xs text-blue-300/70 max-w-3xl">
            * OBC is based on your total cruise fare before taxes and port fees. Applied after final payment via Boardwalk Travel Agency. Has no cash value, cannot be combined with other agent promotions, and is forfeited if the booking is cancelled or transferred. <Link href="/onboard-credit" className="underline hover:text-blue-200">Full terms</Link>.
          </p>
        </div>
      </section>
