...
export default async function PortHotelGuidePage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-[#0a1628] to-[#1E3A5F] border-b border-blue-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <Link href="/hotels" className="inline-flex items-center gap-2 text-blue-300 hover:text-blue-200 mb-4 transition-colors">
