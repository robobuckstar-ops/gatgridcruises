...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/deal-alerts`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${baseUrl}/flight-deals`, lastModified: new Date(), changeFrequency: 'daily' as const, priority: 0.8 },
    ...
    { url: `${baseUrl}/tools/obc-calculator`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/tools/credit-cards`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    ...
    { url: `${baseUrl}/onboard-credit`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/price-tracker`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.7 },
    { url: `${baseUrl}/concierge`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/already-booked`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${baseUrl}/giving-back`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.6 },
    ...
    { url: `${baseUrl}/referral`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.4 },
