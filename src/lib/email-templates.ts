...
export function INQUIRY_RECEIVED(data: InquiryData): string {
  ...
  return wrapBookingEmail(`
    ...
    <p style="margin:0 0 20px;color:#334155;font-size:15px;line-height:1.6;">
      Thanks for your interest in a Disney cruise! We received your request and a specialist will review your preferences and get back to you within <strong>24 hours</strong> with personalized options.
    </p>
    ...
    <p style="margin:0;color:#64748B;font-size:13px;">Talk soon,<br><strong style="color:#1E3A5F;">Your GatGrid Cruises Specialist</strong><br>Licensed Travel Advisor · Boardwalk Travel Agency</p>
  `)
}
...
export function QUOTE_FOLLOW_UP(name: string, options: QuoteOption[]): string {
  ...
  return wrapBookingEmail(`
    ...
    <p style="margin:0;color:#64748B;font-size:13px;">Ready to move forward? Just reply.<br><br><strong style="color:#1E3A5F;">Your GatGrid Cruises Specialist</strong></p>
  `)
}
...
export function BOOKING_CONFIRMED(details: BookingDetails): string {
  ...
  return wrapBookingEmail(`
    ...
    <p style="margin:0;color:#64748B;font-size:13px;">Safe travels!<br><strong style="color:#1E3A5F;">Your GatGrid Cruises Specialist</strong></p>
  `)
}
...
export function REMINDER_90_DAYS(name: string, shipName: string, sailDate: string, bookingRef: string): string {
  ...
  return wrapBookingEmail(`
    ...
    <p style="margin:0;color:#64748B;font-size:13px;">Reply with any questions!<br><strong style="color:#1E3A5F;">Your GatGrid Cruises Specialist</strong></p>
  `)
}
...
export function REMINDER_60_DAYS(name: string, shipName: string, sailDate: string): string {
  ...
  return wrapBookingEmail(`
    ...
    <p style="margin:0;color:#64748B;font-size:13px;">Almost there!<br><strong style="color:#1E3A5F;">Your GatGrid Cruises Specialist</strong></p>
  `)
}
...
export function REMINDER_30_DAYS(name: string, shipName: string, sailDate: string, departurePort: string): string {
  ...
  return wrapBookingEmail(`
    ...
    <p style="margin:0;color:#64748B;font-size:13px;">So close! Reply if you need anything.<br><strong style="color:#1E3A5F;">Your GatGrid Cruises Specialist</strong></p>
  `)
}
...
export function POST_CRUISE(name: string, shipName: string, returnDate: string): string {
  return wrapBookingEmail(`
    ...
    <p style="margin:0;color:#64748B;font-size:13px;">Thank you for choosing GatGrid Cruises!<br><strong style="color:#1E3A5F;">Your GatGrid Cruises Specialist</strong></p>
  `)
}
