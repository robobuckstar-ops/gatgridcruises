...
export function welcomeEmail3(name: string, unsubToken: string): string {
  return dripWrap('The Credit Cards That Save You Hundreds on a Disney Cruise', `
    ...
    <div class="card-box">
      ...
      <a href="https://www.referyourchasecard.com/226m/6ZT33F9TOQ" class="cta-navy" style="font-size: 13px; padding: 10px 20px;">Apply for Chase Ink →</a>
    </div>
    ...
    <div class="card-box">
      ...
      <a href="https://i.capitalone.com/JKlfRwN3f" class="cta-navy" style="font-size: 13px; padding: 10px 20px;">Apply for Venture X →</a>
    </div>
    ...
    <div class="card-box">
      ...
      <a href="https://americanexpress.com/en-us/referral/business-platinum-charge-card?ref=CRYSTSGCNM&XL=MIMNS" class="cta-navy" style="font-size: 13px; padding: 10px 20px;">Apply for Amex Biz Plat →</a>
    </div>
    ...
    <p>These are affiliate links — if you apply and are approved, I earn a small commission at no cost to you. I only recommend cards I'd tell a friend to get.</p>
...
export function preCruise60Days(name: string, shipName: string, sailDate: string, unsubToken: string): string {
  return dripWrap('60 Days to Your Disney Cruise — Packing Time!', `
    ...
    <div class="card-box">
      ...
      <ul class="checklist">
        <li><a href="https://www.amazon.com/s?k=magnetic+hooks+cruise&tag=thm1230b0300-20" style="color: #1E3A5F;">Magnetic hooks</a> — Disney ships have magnetic cabin walls. Hang lanyards, towels, and accessories without damaging anything.</li>
        <li><a href="https://www.amazon.com/s?k=over+the+door+organizer+shoe&tag=thm1230b0300-20" style="color: #1E3A5F;">Over-door shoe organizer</a> — Transforms tiny cabin storage. Perfect for sunscreen, snacks, and toiletries.</li>
        <li><a href="https://www.amazon.com/s?k=travel+power+strip+cruise&tag=thm1230b0300-20" style="color: #1E3A5F;">Surge protector/power strip</a> — Cabins have 2–3 outlets for 4 people. Bring a strip (no extension cords).</li>
        <li><a href="https://www.amazon.com/s?k=reusable+water+bottle+insulated&tag=thm1230b0300-20" style="color: #1E3A5F;">Insulated water bottle</a> — Free water is always available. Save money, stay hydrated in port.</li>
        <li><a href="https://www.amazon.com/s?k=reef+safe+sunscreen&tag=thm1230b0300-20" style="color: #1E3A5F;">Reef-safe sunscreen</a> — Required at Castaway Cay. Bring enough from home to save significant money vs. onboard prices.</li>
        <li><a href="https://www.amazon.com/s?k=waterproof+phone+pouch&tag=thm1230b0300-20" style="color: #1E3A5F;">Waterproof phone pouch</a> — For Castaway Cay beach days and excursion water activities.</li>
        <li><a href="https://www.amazon.com/s?k=packing+cubes+travel&tag=thm1230b0300-20" style="color: #1E3A5F;">Packing cubes</a> — Keep the cabin tidy and find outfits quickly without digging through luggage.</li>
      </ul>
    </div>

    <p><strong>For Castaway Cay days:</strong></p>
    <ul class="checklist">
      <li><a href="https://www.amazon.com/s?k=rash+guard+kids+UPF+50&tag=thm1230b0300-20" style="color: #1E3A5F;">UPF 50 rash guards for kids</a> — Much better than reapplying sunscreen all day</li>
      <li><a href="https://www.amazon.com/s?k=aqua+water+shoes&tag=thm1230b0300-20" style="color: #1E3A5F;">Water shoes</a> — The Castaway Cay beach has some rocky spots near the water's edge</li>
      <li><a href="https://www.amazon.com/s?k=snorkel+set+adult&tag=thm1230b0300-20" style="color: #1E3A5F;">Snorkel set</a> — Rentals are available but bringing your own saves $20+ per person</li>
    </ul>
