...
export function welcomeEmail3(name: string, unsubToken: string): string {
  return dripWrap('The Credit Cards That Save You Hundreds on a Disney Cruise', `
    ...
    <div class="card-box">
      ...
      <a href="https://gatgridcruises.com/concierge" class="cta-navy" style="font-size: 13px; padding: 10px 20px;">Learn More →</a>
    </div>
    ...
    <p>I only recommend cards I'd tell a friend to get. Our advisors can help you find the right option for your situation.</p>
