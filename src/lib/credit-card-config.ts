...
export const creditCards: CreditCard[] = [
  ...
  },
  {
    ...
    annualFee: 0,
    signupBonus: '$1,000 cash back',
    signupBonusValue: 1000,
    signupBonusRequirement: 'Spend $8,000 in first 4 months',
    ...
    highlights: [
      ...
      '$1,000 cash back after $8,000 spend in 4 months (limited-time, all-time high)',
